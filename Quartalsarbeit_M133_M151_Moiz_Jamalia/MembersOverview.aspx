<%@ Page Title="MEVS - Member Overview" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MembersOverview.aspx.cs" 
    Inherits="Quartalsarbeit_M133_M151_Moiz_Jamalia.MembersOverview" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PlaceHolderMain" runat="server">
    ...
    <div class="GVStyle">
        ...
        <asp:GridView ID="GvSignUps" runat="server" CssClass="table--centered table table is-striped" HeaderStyle-CssClass="thead" RowStyle-CssClass="tr" AutoGenerateColumns="false"
            OnPageIndexChanging="GvSignUps_PageIndexChanging" OnRowCommand="GvSignUps_RowCommand" >
        ...
        <asp:GridView ID="GvMembers" runat="server" CssClass="table--centered table table is-striped" HeaderStyle-CssClass="thead" RowStyle-CssClass="tr" AutoGenerateColumns="false"
            OnPageIndexChanging="GvMembers_PageIndexChanging" OnRowCancelingEdit="GvMembers_RowCancelingEdit" OnRowDeleting="GvMembers_RowDeleting"
            OnRowEditing="GvMembers_RowEditing" OnRowUpdating="GvMembers_RowUpdating" OnRowDataBound="GvMembers_RowDataBound">
            <Columns>
    ...
    <asp:Button ID="btnLogOut" Text="Log Out" runat="server" Style="font-weight: bold; bottom: 0; left: 0; position: fixed; margin: 2vh; font-size: 2.3vh" CssClass="button is-dark" 
