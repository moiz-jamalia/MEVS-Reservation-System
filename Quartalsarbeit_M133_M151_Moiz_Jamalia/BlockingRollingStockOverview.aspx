<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BlockingRollingStockOverview.aspx.cs" Inherits="Quartalsarbeit_M133_M151_Moiz_Jamalia.BlockingTimesOverview" %>
<asp:Content ID="Content1" ContentPlaceHolderID="PlaceHolderHeader" runat="server">
    ...
    <div class="navbar_overview">
        ...
        <asp:HyperLink Text="Blocking Rolling Stock" NavigateUrl="~/BlockingRollingStockOverview.aspx" runat="server" CssClass="active navbar_text"/>
